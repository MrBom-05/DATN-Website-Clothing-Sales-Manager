...
<div>
    ...
    <h6 class="text-center">
        năm cuối thập niên 90 cho tới tận bây giờ. “n” Chính là số đông, là cộng đồng, chính vì thế cái
    </h6>
    <h6 class="text-center">
        tên “Leninn” ra đời, chúng tôi không phải cá nhân, chúng tôi được sáng lập bởi cộng đồng!
    </h6>
