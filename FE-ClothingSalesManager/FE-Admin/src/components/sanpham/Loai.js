...
export default function Loai() {
    const api = "http://localhost:8080/api/admin/loai";
            ...
            fetch(api + `${loai.id ? `/${loai.id}` : ''}`, {
                ...
                .then(() => {
                    fetch(api)
                        ...
                        .catch((error) => {
                            console.error(`Lỗi khi lấy danh sách sau khi ${loai.id ? 'cập nhật' : 'thêm'}:`, error);
                        });
                })
                .catch((error) => {
        ...
        <div className='px-3'>
            ...
            <Grid container spacing={2} className="mt-3">
                                    ...
                                    <TableRow key={loai.id}>
                                        ...
                                        <TableCell className="text-center">
                                            <button
                                                ...
                                                onClick={() => {
                                                    if (window.confirm('Bạn có chắc chắn muốn xoá ' + loai.ten + ' không?')) {
                                                        handleDeleteLoai(loai.id);
                                                    }
                                                }}
                                            >
                                                Delete
                ...
                <Grid item xs={4} className="text-center">
                    ...
                    <Button variant="contained" color="success" onClick={handleAddLoai}
